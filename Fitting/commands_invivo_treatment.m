...
figure
hold on 
plot(Days, nanmean(Tvol'));

Tvol_data = nanmean(Tvol(1:7,:)');
Days_data = Days(1:7);
...
p.r =0.1321;
p.L = 2.73*1e9;
p.beta = 270.8;%3.638*24;%?
p.h = 1;
p.k = 0.1973;%0.0083*24;%*24
p.eps = 0.1716;%0.1483;
p.gam = 4.25*1e3;%4.168*1e3;
p.d_D = 4.8;
p.alpha = 100.56;%135.09;
p.alpha_2 = 0.001;
p.d_V = 23.11;%1.6017*24;
p.d_B = 7.89;%-log(0.5)/2;
p.d_T = 0.35;%0.21;
p.s = 1;
p.eta = 9.04*1e5;%1.071*1e5;
